...
import { UserProjectPageComponent } from "./projects/pages/user-project-page/user-project-page.component";
...
const routes: Routes = [
  ...
  { path: "gebruiker/opdrachten", component: UserProjectPageComponent },
